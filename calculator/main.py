...
root.geometry('394x403')
root.resizable(0,0)
root.configure(background='#FFBF00')

# Create Result Label
result_label = Label(root,text='',bg='#FFBF00')
result_label.grid(row=0,column=0,columnspan=6,sticky='w',pady=(50,25))
...
btn_equal.config(font=('verdana',16))
